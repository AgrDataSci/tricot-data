# .............................................
# This script will handle the CIP potato data #####
# first run: July 2025
...
# funders 
funders = read_excel('metadata/trials-metadata/potato-nigeria/funder-metadata.xlsx')
...
pi_email = "kalpana.sharma@cgiar.org"
...
crop_taxon = "Solanum tuberosum"

# filter the worlveg projects
keep = grep("88f82a3f073e", projects$project_id)
...
for(k in seq_along(cmdata)) {
  ...
  block = exportBlockData(x, seed = 1554)
