...
geno = read_excel('raw/variety-metadata/groundnut-tanzania.xlsx')
...
trial_description = paste("On-farm trials implemented under the scope of", 
                          ...
                          "groundnut varieties on-farm.")


institute = "Tanzania Agriculture Research Institute"

pi = "Happy Daudi"

pi_email = "h.daudi@cgiar.org"
...
crop_taxon = "Arachis hypogaea"

# filter the worlveg projects
keep = grep("Happy", projects$user_owner)
