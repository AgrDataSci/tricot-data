---
title: "The triadic comparison of technology options (tricot) data from XX on-farm experimental trials in YY countries"
...
> Kauê de Sousa^1,2,+,\*^, Marie-Angélique Laporte^1,+^, Hugo Dorado^1,3^, [add others in alphabetical, check table below...], Jacob van Etten^1^,

> ^1^ Digital Inclusion, Bioversity International, Montpelier, France\
> ^2^ Department of Agricultural Sciences, Inland Norway University of Applied Sciences, 2318 Hamar, Norway\
> ^3^ Plant Production Systems, Wageningen University and Research, Wageningen, The Netherlands\
